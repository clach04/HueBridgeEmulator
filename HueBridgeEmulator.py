    ...
    while run_service:
              ...
              if data[0:19]== 'M-SEARCH * HTTP/1.1':
                   if data.find("ssdp:all") != -1:
                          ...
                          print("Sending M Search response to %r" %(address,))
                          #print("\tSending M Search response to %r" % ((address, data),))  # data doesn't usually have much information about the requester
